...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url().'theme/images/banner/logo-header.png'?>"/>
                        ...
                        <div class="col-lg-9">
                            <div class="availability-form">
                                <div class="vailability-submit">
                                    <a href="<?php echo site_url('rooms');?>" class="awe-btn awe-btn-13">Sewa Sekarang!</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="room-detail_compare">
                    ...
                    <div class="col col-xs-12 col-lg-6 col-lg-offset-3">
                        <div class="ot-heading row-20 mb30 text-center">
                            <h2 class="shortcode-heading">GEDUNG</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <a href="<?php echo site_url('rooms');?>" class="awe-btn awe-btn-default font-hind f12 bold btn-medium mt15">Lihat Semua</a>
                </div>
    ...
    <!-- END / DEALS PACKAGE -->
        ...
        <section class="section-blog bg-white">
            <div class="container">
                ...
                <div class="text-center">
                    <a href="<?php echo site_url('blog');?>" class="awe-btn awe-btn-default font-hind f12 bold btn-medium mt15">Lihat Semua</a>
                </div>
            </div>
