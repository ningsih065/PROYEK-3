                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="<?php echo base_url().'admin/dashboard'?>">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">SE</span><span class="font-size-xl text-success"><strong>DUNG</strong></span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Created with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="http://mfikri.com" target="_blank">kelompok 6</a>
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="https://mfikri.com" target="_blank">Kelompok 6</a> &copy; <span class="js-year-copy"><?php echo date('Y');?></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
